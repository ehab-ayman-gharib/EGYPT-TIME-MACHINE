...
- CLOTHING & HEADWEAR LOGIC:
  - If the person in the source photo has headwear (like a hat or hijab), you MUST keep the face with era-relevant headwear.
  - If the person has NO headwear and shows hair, do NOT force headwear on them. It is OK to show hair in the generated image (styled relevant to the era).
...
export const FEMALE_WARDROBE_STYLES = [
  "a simple and elegant long-sleeved silk-blend blouse in a soft lilac tone, paired with light-coloured tailored cotton trousers, topped with a matching modern baseball cap.",
  "a modern, minimalist solid-colored Egyptian linen knee-length dress in a soft coral tone, paired with a wide-brim natural straw sun hat.",
  "a stylish white linen tunic with V-neckline and subtle embroidery, paired with slim-fit dark navy trousers and a chic navy blue bucket hat.",
  "a casual yet chic terracotta-colored cotton jumpsuit with a cinched waist and short sleeves, worn with a trendy neutral-toned flat cap.",
  "a refined emerald green silk shirt with an open collar tucked into high-waisted beige linen pants, completed with a sophisticated patterned silk head scarf.",
  "a sleek navy blue short-sleeved premium cotton boiler-suit with a wide belt.",
  "a fluid burgundy silk blouse with a modern open collar, tucked into high-waisted cream trousers.",
    ...
    scenery: [
      {
        ...
        maleClothingIds: [
          "Pharaoh's River Ceremony Regalia: A full white linen tunic with long sleeves. A massive gold Wesekh collar. Holds the Heqa crook. Era-relevant Headwear (if user wears headwear): The blue-and-gold striped Nemes headdress .",
          "High Priest of Amun: A full long-sleeved white linen tunic with a broad white linen sash. A heavy gold pectoral necklace. Era-relevant Headwear (if user wears headwear): A tall white Hedjet crown .",
          "Royal Herald: A full white linen tunic with a broad gold sash. Era-relevant Headwear (if user wears headwear): The red Deshret crown of Lower Egypt .",
        ],
        femaleClothingIds: [
          "Hathor Incarnation: A form-fitting ankle-length red and orange diamond-patterned sheath dress with long sleeves. A massive gold Wesekh collar. Era-relevant Headwear (if user wears headwear): Large curved cow horns with a huge bright red sun disk in the center, resting on a long black wig.",
          "Royal Matriarch: A long white and black layered linen dress with a wide gold belt and gold armbands. Era-relevant Headwear (if user wears headwear): A simple thick gold headband with a Uraeus cobra at the brow.",
          "High Priestess of Isis: A fitted white linen dress with complex gold embroidery at the neckline. Era-relevant Headwear (if user wears headwear): The tall flat-topped blue cylindrical crown (Khepresh) fully covering the head.",
        ],
      },
      {
        ...
        maleClothingIds: [
          "Pharaoh's Victory Regalia: A full white linen tunic. A massive gold Wesekh collar. Holds a gold Khopesh. Era-relevant Headwear (if user wears headwear): The tall gold and blue Pschent double crown .",
          "High Priest: A full white linen tunic with a leopard skin drape across one shoulder. Era-relevant Headwear (if user wears headwear): A tall white Hedjet crown .",
          "Noble Vizier: A long linen gown with a wide gold sash. Era-relevant Headwear (if user wears headwear): The blue-and-gold striped Nemes headdress .",
        ],
        femaleClothingIds: [
          "Royal Matriarch: A long ankle-length stiff pleated white linen Kalasiris gown with long sleeves fully covering the arms, decorated with gold thread embroidery along all seams. A broad multi-row Wesekh collar inlaid with lapis lazuli, carnelian, and gold covering the shoulders and upper chest. On the right upper arm over the sleeve: a gold serpent armband coiling three times around the arm with a raised serpent head at the top. On the left wrist over the sleeve: a wide gold cuff bracelet engraved with hieroglyphic inscriptions. Long dangling gold and gemstone earrings. Heavy gold bracelets on both wrists. Fine leather sandals. Era-relevant Headwear (if user wears headwear): The tall flat-topped blue cylindrical crown (Khepresh) with absolutely NO hair visible whatsoever  fully covering the entire head, encircled at the base by a wide gold band inlaid with alternating red, blue, and green gemstone panels, with a multicolored gold Uraeus cobra rearing at the brow.",
      ...
      },
      {
        ...
        maleClothingIds: [
          "Pharaoh's Temple Regalia: A full white linen tunic. A massive gold Wesekh collar. Era-relevant Headwear (if user wears headwear): The tall white Hedjet crown .",
          "High Priest: A floor-length pleated linen robe with a wide gold sash. Era-relevant Headwear (if user wears headwear): The red Deshret crown of Lower Egypt .",
          "Royal Sculptor: A simple white linen tunic with a leather belt. Era-relevant Headwear (if user wears headwear): The blue-and-gold striped Nemes headdress .",
        ],
        femaleClothingIds: [
      ...
      },
      {
        ...
        maleClothingIds: [
          "Pharaoh's Court Regalia: A sheer fine white linen long tunic. Era-relevant Headwear (if user wears headwear): The Pschent double crown .",
          "Palace Vizier: A long starched linen gown with a gold pectoral. Era-relevant Headwear (if user wears headwear): A tall white Hedjet crown .",
          "Royal Scribe: A simple linen tunic with a wide woven sash. Era-relevant Headwear (if user wears headwear): The blue-and-gold striped Nemes headdress .",
        ],
      ...
      },
      {
        ...
        maleClothingIds: [
          "Pharaoh's Processional Regalia: A full white linen tunic. Era-relevant Headwear (if user wears headwear): The tall blue leather Khepresh war crown .",
          "Temple Guardian: A long starched linen tunic with a wide leather belt. Era-relevant Headwear (if user wears headwear): A tall white Hedjet crown .",
          "Royal Herald: A simple linen tunic with a gold-threaded sash. Era-relevant Headwear (if user wears headwear): The blue-and-gold striped Nemes headdress .",
        ],
      ...
      },
      {
        ...
        maleClothingIds: [
          "Pharaoh's Funerary Regalia: A full white linen tunic. A massive gold Wesekh collar. Era-relevant Headwear (if user wears headwear): The Atef funerary crown .",
          "High Priest: A full white linen tunic with a sacred sash. Era-relevant Headwear (if user wears headwear): The tall white Hedjet crown .",
          "Vizier: A majestic linen gown. Era-relevant Headwear (if user wears headwear): The blue-and-gold striped Nemes headdress .",
        ],
        femaleClothingIds: [
          "Royal Mourner Queen: A long ankle-length fitted white linen dress with long sleeves fully covering the arms. A multi-row gold Wesekh collar inlaid with lapis lazuli covering the shoulders and upper chest. On the right upper arm over the sleeve: a gold serpent armband coiling three times around the arm with a raised serpent head at the top. On the left wrist over the sleeve: a wide gold cuff bracelet engraved with hieroglyphic inscriptions. Long dangling gold and lapis lazuli earrings. Fine gold sandals. Era-relevant Headwear (if user wears headwear): The tall flat-topped blue cylindrical crown (Khepresh) with absolutely NO hair visible whatsoever  fully covering the entire head, encircled at the base by a wide gold band inlaid with alternating red, blue, and green gemstone panels, with a multicolored gold Uraeus cobra rearing at the brow.",
      ...
      },
      {
        ...
        maleClothingIds: [
          "Hatshepsut Pharaoh Regalia: A full white linen tunic fully covering the chest and torso. A massive gold Wesekh collar inlaid with turquoise and lapis lazuli sitting on top of the tunic. A stiff white linen Shendyt kilt with a triangular apron and gold central belt panel. Heavy gold armbands and wrist cuffs. Holds the gold Heqa crook and Nekhekh flail. Era-relevant Headwear (if user wears headwear): The red Deshret crown of Lower Egypt with a gold Uraeus cobra rearing at the brow.",
          "High Priest of Amun: A full white linen tunic fully covering the chest and torso with a broad white linen sash draped precisely over one shoulder. A heavy gold pectoral necklace sitting on top of the tunic and gold wrist cuffs. A wide decorated gold belt at the waist. Era-relevant Headwear (if user wears headwear): The red Deshret crown of Lower Egypt with a gold Uraeus cobra rearing at the brow.",
          "Royal Fan Bearer: A full white linen tunic fully covering the chest and torso with a broad gold sash across the chest. A gold Wesekh collar sitting on top of the tunic. A decorated gold belt at the waist. Holds a tall ceremonial Ostrich Feather Flabellum. Era-relevant Headwear (if user wears headwear): The red Deshret crown of Lower Egypt with a gold Uraeus cobra rearing at the brow.",
        ],
        femaleClothingIds: [
    ...
    scenery: [
      {
        ...
        maleClothingIds: [
          "Coptic Worshipper's Tunic: A long unbleached linen tunic with broad dark purple wool clavi stripes running from shoulders to hem. Tapestry-woven orbiculi roundels with interlace motifs on the lower tunic. A thin woven linen belt at the waist. Era-relevant Headwear (if user wears headwear): A plain white linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held in place by a gold and black geometric zigzag crown headband.",
          "Coptic Parish Elder's Tunic: A long undyed linen tunic with wide dark red wool clavi stripes and square tabulae embellishments on each shoulder. A simple leather belt at the waist. Era-relevant Headwear (if user wears headwear): A natural linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by a gold and black geometric zigzag crown headband.",
          "Coptic Deacon's Tunic: A long ivory linen tunic with narrow dark blue clavi stripes and small tapestry-woven medallions near the hem. A braided wool sash at the waist. Era-relevant Headwear (if user wears headwear): A white linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
          "Coptic Musician's Garb: A long saffron-tinted linen tunic with vibrant red clavi stripes and elaborate floral tapestry roundels near the cuffs. A wide leather sash at the waist. Era-relevant Headwear (if user wears headwear): A saffron linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
          "Coptic Monk's Simple Habit: A long coarse undyed wool tunic with a single narrow black clavi stripe on each shoulder. A simple rope belt at the waist. Era-relevant Headwear (if user wears headwear): A plain undyed linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Scholar's Tunic: A long fine ivory linen tunic with dark blue clavi stripes and delicate tapestry-woven medallions on the shoulders. A thin linen sash at the waist. Era-relevant Headwear (if user wears headwear): A white linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
        ],
        femaleClothingIds: [
          "Coptic Noblewoman's Tunic: A long ankle-length linen tunic in natural flax color with wide tapestry-woven clavi stripes in deep purple wool running from shoulders to hem. Square tabulae embellishments on each shoulder woven with Coptic cross and geometric diamond patterns in red and gold wool. Wide sleeves with tapestry-woven cuffs. A narrow woven linen sash at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A fine ivory linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Merchant's Wife Tunic: A long ankle-length wool tunic in deep terracotta red with narrow dark blue clavi stripes and orbiculi roundels near the hem woven with geometric interlace patterns. Very wide sleeves embroidered along the seams with chevron and diamond motifs. A braided wool sash at the waist.  Closed leather shoes. Era-relevant Headwear (if user wears headwear): A terracotta-colored linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Laywoman's Robe: A long ankle-length undyed linen T-shaped robe with straight seams and very wide sleeves, embroidered along the shoulder seams and around the neck opening with geometric Coptic cross motifs in red wool thread. A simple leather belt at the waist.  Closed leather shoes. Era-relevant Headwear (if user wears headwear): A plain white linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Artisan's Dress: A long forest-green wool tunic with diagonal clavi stripes in yellow and black wool. Embroidered circular motifs on the chest showing stylized doves. A woven flax belt. Era-relevant Headwear (if user wears headwear): A green linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Nun's Habit: A long ankle-length coarse dark brown wool tunic with a single narrow black clavi stripe on each shoulder. A knotted rope cord at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A dark brown wool veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple plain gold circlet headband.",
          "Coptic Noble's Daughter: A long ankle-length fine silk tunic in deep violet with silver embroidery along the neckline and cuffs. A thin silk sash at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A fine ivory linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
        ],
      ...
      },
      {
        ...
        maleClothingIds: [
          "Coptic Liturgical Tunic: A long fine linen tunic in natural flax color with broad purple wool clavi stripes and tapestry-woven tabulae on the shoulders. A thin braided linen belt at the waist. Era-relevant Headwear (if user wears headwear): A white linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by a gold and black geometric zigzag crown headband.",
          "Byzantine-Coptic Noble's Tunic: A long deep ivory linen tunic with wide clavi stripes in dark blue wool and orbiculi roundels on the lower hem. A narrow leather belt at the waist. Era-relevant Headwear (if user wears headwear): A fine undyed linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
          "Coptic Cantor's Robe: A long natural linen tunic with dark wool clavi stripes and square tabulae on each shoulder with monochrome interlace knot patterns. A simple woven wool sash at the waist. Era-relevant Headwear (if user wears headwear): A plain linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by a gold and black geometric zigzag crown headband.",
          "Coptic Scribe: A long off-white linen tunic with narrow blue clavi and a small ink-pot holder attached to the leather belt. Era-relevant Headwear (if user wears headwear): A simple white linen veil.",
        ],
        femaleClothingIds: [
          "Coptic Deaconess Tunic: A long ankle-length deep ivory linen tunic with broad tapestry-woven clavi stripes in dark blue wool featuring geometric interlace and cross motifs. Wide sleeves with tapestry-woven bands at the cuffs. Orbiculi roundels near the hem with abstract interlace cross patterns. A braided linen sash at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A white linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Elder Woman's Robe: A long ankle-length dark blue wool T-shaped robe with very wide sleeves, embroidered along all seams and shoulders with red and gold geometric diamond lattice and abstract zigzag patterns. A wide woven wool sash at the waist.  Closed leather shoes. Era-relevant Headwear (if user wears headwear): A dark blue wool veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Widow's Tunic: A long ankle-length undyed rough linen tunic with narrow dark wool clavi stripes and simple geometric orbiculi roundels near the hem. Very wide plain sleeves. A plain rope cord tied at the waist.  Closed leather shoes. Era-relevant Headwear (if user wears headwear): A plain undyed linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Noble's Daughter: A fine silk tunic in deep violet with silver embroidery. Era-relevant Headwear (if user wears headwear): A silver circlet over an ivory veil.",
        ],
      },
      {
        ...
        maleClothingIds: [
          "Coptic Pilgrim's Tunic: A long coarse undyed rough linen tunic with narrow dark brown wool clavi stripes and simple orbiculi roundels near the hem. A knotted rope cord at the waist. Era-relevant Headwear (if user wears headwear): A rough undyed linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
          "Penitent's Tunic: A long plain dark brown wool tunic with a single narrow clavi stripe on each shoulder in black wool. A rough rope belt at the waist. Era-relevant Headwear (if user wears headwear): A coarse dark brown linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by a gold and black geometric zigzag crown headband.",
          "Desert Worshipper's Tunic: A long worn natural linen tunic with faded red-brown clavi stripes and barely visible tapestry-woven interlace motifs near the hem. A weathered leather cord at the waist. Era-relevant Headwear (if user wears headwear): A dusty undyed linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
        ],
        femaleClothingIds: [
          "Coptic Pilgrim Woman's Tunic: A long ankle-length coarse undyed linen T-shaped robe with very wide sleeves and narrow dark brown wool clavi stripes. Simple geometric embroidery along the neck opening and shoulder seams in abstract zigzag patterns. A knotted rope cord at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A rough undyed linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple worn gold circlet headband.",
          "Coptic Penitent's Robe: A long ankle-length dark brown wool tunic, plain and undecorated except for a single narrow clavi stripe on each shoulder and a small hand-stitched geometric Coptic cross near the collar. A simple rope belt at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A coarse dark brown linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Worshipper's Tunic: A long ankle-length worn natural linen tunic with faded red-brown clavi stripes and barely visible tapestry-woven geometric orbiculi motifs near the hem. Wide sleeves with simple abstract embroidery along the seams. A weathered leather belt at the waist.  Closed leather shoes. Era-relevant Headwear (if user wears headwear): A dusty undyed linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
        ],
      ...
      },
      {
        ...
        maleClothingIds: [
          "Coptic Nobleman's Tunic: A long fine linen tunic in natural flax with elaborate polychrome tapestry-woven clavi stripes featuring vine scrolls and Christian symbols. Wide square tabulae on each shoulder with figural medallions. A wide decorated leather belt at the waist. Era-relevant Headwear (if user wears headwear): A light ivory linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by an ornate gold and black geometric zigzag crown headband.",
          "Coptic Artisan's Tunic: A long sturdy linen tunic with vivid red and dark blue clavi stripes and orbiculi roundels at the hem woven with interlace and floral motifs. A braided wool belt at the waist. Era-relevant Headwear (if user wears headwear): A natural linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
          "Coptic Scholar's Tunic: A long pale ivory linen tunic with dark monochrome clavi stripes and delicate tabulae on the shoulders with abstract geometric and cross patterns. A thin linen sash at the waist. Era-relevant Headwear (if user wears headwear): A white linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by a gold and black geometric zigzag crown headband.",
        ],
        femaleClothingIds: [
          "Coptic Aristocrat's Tunic: A long ankle-length fine linen tunic in natural flax with elaborate polychrome tapestry-woven clavi stripes featuring abstract geometric interlace, stepped cross patterns, and repeating diamond motifs in vivid red, blue, and gold wool. Wide sleeves with richly decorated tapestry cuffs. Square tabulae on each shoulder with abstract cross medallions. A wide decorated leather belt at the waist. A gold Coptic cross necklace hanging at the chest. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A fine ivory linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by an ornate gold circlet headband.",
          "Coptic Artisan Woman's Robe: A long ankle-length sturdy linen T-shaped robe with vivid red and dark blue clavi stripes and orbiculi roundels at the hem woven with abstract interlace and repeating geometric floral rosette motifs. Very wide sleeves embroidered along the seams with chevron patterns. A braided wool belt at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A natural linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Coptic Scholar Woman's Tunic: A long ankle-length pale ivory linen tunic with dark monochrome clavi stripes and delicate tabulae on the shoulders woven with abstract stepped cross and interlace geometric patterns. Wide sleeves with narrow tapestry-woven cuffs. A thin linen sash at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A white linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
        ],
      ...
      },
      {
        ...
        maleClothingIds: [
          "Coptic Desert Monk's Habit: A long coarse dark brown wool tunic reaching the ankles with a single narrow black clavi stripe on each shoulder and a small woven cross near the collar. A knotted rope cord at the waist. Era-relevant Headwear (if user wears headwear): A dark brown linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
          "Hermit's Tunic: A very coarse patched undyed rough linen tunic, entirely plain with no decoration. A simple rough rope belt at the waist. Era-relevant Headwear (if user wears headwear): A weathered undyed linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by a worn gold and black geometric zigzag crown headband.",
          "Novice Monk's Tunic: A long plain undyed linen tunic with a single narrow dark wool clavi stripe on each shoulder. A thin leather cord at the waist. Era-relevant Headwear (if user wears headwear): A plain white linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
        ],
        femaleClothingIds: [
          "Coptic Desert Nun's Habit: A long ankle-length coarse dark brown wool tunic reaching the ground with a single narrow black clavi stripe on each shoulder and a small geometric woven Coptic cross near the collar. Very wide plain sleeves. A knotted rope cord at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A dark brown wool veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple plain gold circlet headband.",
          "Coptic Hermit Woman's Robe: A very coarse patched undyed rough linen T-shaped robe, entirely plain with no decoration except a faint geometric cross outline stitched near the collar. A rough rope belt at the waist. A simple wooden Coptic cross necklace hanging at the chest. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A weathered undyed linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a worn simple gold circlet headband.",
          "Coptic Monastery Visitor's Tunic: A long ankle-length plain undyed linen tunic with a single narrow dark wool clavi stripe on each shoulder and simple abstract geometric embroidery around the neck opening. Wide plain sleeves. A thin leather cord at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A plain white linen veil that can cover hair with absolutely no hair visible whatsoever, falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
        ],
      },
      {
        ...
        maleClothingIds: [
          "Sinai Monastery Robe: A long heavy undyed wool tunic with broad dark clavi stripes on each shoulder and tapestry-woven orbiculi roundels near the hem. A thick leather belt at the waist. Era-relevant Headwear (if user wears headwear): A dark grey linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by a gold and black geometric zigzag crown headband.",
          "Byzantine Pilgrim's Tunic: A long deep navy blue wool tunic with gold-yellow clavi stripes and square tabulae on the shoulders with cross and geometric motifs. A woven wool sash at the waist. Era-relevant Headwear (if user wears headwear): A navy linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, held by a gold and black geometric zigzag crown headband.",
          "Desert Traveler's Tunic: A long dusty off-white linen tunic with narrow brown clavi stripes and simple orbiculi roundels at the hem. A worn leather belt at the waist. Era-relevant Headwear (if user wears headwear): A loose off-white linen veil covering the top of the head only, with the fabric falling straight down the back like a cape, ears, and neck, secured by a gold and black geometric zigzag crown headband.",
        ],
        femaleClothingIds: [
          "Sinai Pilgrim Woman's Robe: A long ankle-length heavy undyed wool T-shaped robe with broad dark clavi stripes on each shoulder and tapestry-woven orbiculi roundels near the hem with abstract monochrome interlace and stepped cross patterns. Very wide sleeves with geometric embroidery along the seams. A thick leather belt at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A dark grey linen veil , falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Byzantine Coptic Noblewoman's Tunic: A long ankle-length deep navy blue wool tunic with gold-yellow clavi stripes and square tabulae on the shoulders woven with abstract Coptic cross and repeating geometric diamond motifs. Wide sleeves with tapestry-woven cuffs. A woven wool sash at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A navy linen veil , falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
          "Desert Traveler Woman's Tunic: A long ankle-length dusty off-white linen tunic with narrow brown clavi stripes and simple geometric orbiculi roundels at the hem. Very wide plain sleeves with abstract zigzag embroidery along the shoulder seams. A worn leather belt at the waist. Closed leather shoes. Era-relevant Headwear (if user wears headwear): A loose off-white linen veil , falling straight down the back like a cape, ears, and neck, held by a simple gold circlet headband.",
        ],
      }
    ],
    stamps: [
    ...
    scenery: [
      {
        ...
        maleClothingIds: [
          "Abbasid Scholar: A long ankle-length fine white Egyptian linen qamis (shirt-tunic) with wide sleeves, worn under a long ruby silk outer robe (Jubba) with gold Tiraz band embroidered with Kufic calligraphy along the right sleeve. A wide leather belt cinched at the waist. Leather pointed shoes. Era-relevant Headwear (if user wears headwear): A tall cylindrical white taqiyya cap wrapped with a large white linen Imama turban wound neatly around the base of the cap, .",
          "Abbasid Merchant: A long ankle-length natural flax-colored Egyptian linen qamis with wide sleeves, worn under a deep indigo-blue cotton outer robe (Rida) with a horizontal Tiraz band of gold embroidery at the sleeve cuffs. A thick woven fabric sash at the waist. Leather shoes. Era-relevant Headwear (if user wears headwear): A tall cylindrical taqiyya cap wrapped with a large cream-colored linen turban wound firmly around the base, .",
          "Abbasid Dignitary: A long ankle-length fine white linen qamis with wide sleeves, worn under a heavy black silk outer robe (Qaba) with a wide gold Tiraz band of Kufic calligraphy embroidered along the right sleeve. A wide gold-threaded fabric sash at the waist. Leather pointed shoes. Era-relevant Headwear (if user wears headwear): A tall cylindrical taqiyya cap wrapped with a large black silk turban wound elaborately around the base, .",
          "Fatimid Explorer: A long sand-colored linen qamis with narrow sleeves, worn under a dark leather vest with golden geometric buttons. A broad fabric sash with complex interlace patterns. Era-relevant Headwear (if user wears headwear): A tall cylindrical taqiyya cap , wrapped with a sand-colored silk turban, .",
        ],

        femaleClothingIds: [
          "Abbasid Noblewoman: A long ankle-length spacious white Egyptian Dabiqi linen thawb with wide boxy sleeves, embroidered along the sleeve cuffs and neckline with gold Kufic calligraphy Tiraz bands. Worn under a long flowing black silk outer wrap (Izar) draped elegantly over the shoulders. A gold embroidered waist sash (Wasat). Gold chain necklace with a pendant teardrop ruby. Gold drop earrings with pearl inlay. Gold bangles stacked on both wrists. Leather pointed shoes. Era-relevant Headwear (if user wears headwear): A soft black silk hijab veil   loosely draped around the head and falling in soft folds around the neck.",
          "Fatimid Merchant's Wife: A long ankle-length loose deep indigo-blue cotton thawb with wide sleeves, embroidered along the neckline and cuffs with gold geometric Tiraz bands. Worn under a large enveloping cream-colored linen outer mantle (Melaya) draped over the shoulders. A wide woven silk sash at the waist. Gold filigree necklace with turquoise pendants. Gold hoop earrings with turquoise inlay. Gold bangles on both wrists. Leather shoes. Era-relevant Headwear (if user wears headwear): A soft cream linen hijab veil   loosely draped around the head and falling in soft folds around the neck.",
          "Abbasid Scholar's Wife: A long ankle-length fine white silk thawb with wide sleeves and a round neck opening, with gold thread embroidery along all seams and a gold Tiraz band of Kufic calligraphy at the sleeve cuffs. Worn under a long deep saffron-yellow silk outer robe (Rida) draped over the shoulders. A wide gold-threaded silk sash at the waist. Pearl and gold collar necklace. Long dangling gold and pearl earrings. Pearl and gold bangles on both wrists. Fine leather pointed shoes. Era-relevant Headwear (if user wears headwear): A soft white silk hijab veil   loosely draped around the head and falling in soft folds around the neck.",
          "Fatimid Poetess: A long flowing emerald-green silk thawb with tight sleeves, featuring gold brocade panels at the shoulders. A narrow gold belt at the waist and long pearl earrings. Era-relevant Headwear (if user wears headwear): A soft emerald-green silk hijab veil loosely draped around the head.",
        ],
      ...
      },
      {
        ...
        maleClothingIds: [
          "Fatimid Nobleman: A long ankle-length fine white Egyptian Dabiqi linen qamis with wide sleeves and a vertical round collar, worn under a deep saffron-yellow silk outer robe (Rida) with elaborate woven geometric patterns and a gold Tiraz band of Kufic calligraphy along the right sleeve. A wide fabric sash at the waist. Leather pointed shoes. Era-relevant Headwear (if user wears headwear): A tall cylindrical taqiyya cap wrapped with a large white linen Imama turban wound in neat round folds .",
          "Fatimid Merchant: A long ankle-length natural flax-colored Egyptian linen qamis with wide sleeves, worn under a deep cobalt-blue cotton outer robe with a wide horizontal Tiraz gold embroidery band at the sleeve cuffs. A thick woven sash at the waist. Leather shoes. Era-relevant Headwear (if user wears headwear): A tall cylindrical taqiyya cap wrapped with a large cream linen turban wound firmly and neatly .",
          "Abbasid Court Official: A long ankle-length fine white linen qamis with wide sleeves, worn under a heavy black silk Qaba coat with wide sleeves and a prominent gold Tiraz band of Kufic calligraphy embroidered along the right sleeve — the black robes of the Abbasid official class. A wide gold-threaded fabric sash at the waist. Leather pointed shoes. Era-relevant Headwear (if user wears headwear): A tall cylindrical taqiyya cap wrapped with a large black silk turban wound in the official Abbasid court style .",
        ],
        femaleClothingIds: [
